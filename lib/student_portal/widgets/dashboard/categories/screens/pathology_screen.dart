              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: const Text(
                      "Medical Diagnostics & Microbiology",
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
                  ...
                  const Text(
                    "Pathology & Microbiology Masterclass",
                    style: TextStyle(
                      fontSize: 36,
                      fontWeight: FontWeight.bold,
                      color: AppColors.textPrimary,
                  ...
                  const Text(
                    "High-yield cellular pathology, inflammation, immunology, infectious disease microbiology, hematology, and clinical correlation.",
                    style: TextStyle(
                      fontSize: 16,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  _buildCurriculumTile("01", "General Pathology & Cell Injury", "Cell adaptation, necrosis, apoptosis, acute & chronic inflammation.", "25 Lectures"),
                  _buildCurriculumTile("02", "Hematology & Clinical Pathology", "Anemias, leukemias, coagulation defects, urine analysis, CSF examination.", "20 Lectures"),
                  _buildCurriculumTile("03", "Systemic Pathology & Neoplasia", "Cardiovascular, respiratory, gastrointestinal, renal, and endocrine pathology.", "30 Lectures"),
                ],
              ),
            ),
