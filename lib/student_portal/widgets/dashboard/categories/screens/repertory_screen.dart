            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "Detailed study of Kent's, Boenninghausen's, Boger's, Synthesis, and modern clinical repertories with cross-repertorisation case studies.",
                    style: TextStyle(
                      fontSize: 16,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  _buildCurriculumTile("01", "Kent's Repertory", "Philosophical background, plan, construction, gradation, mind rubrics.", "25 Lectures"),
                  _buildCurriculumTile("02", "Boger Boenninghausen's Repertory (BBCR)", "Doctrine of analogy, concomitant symptoms, grand generalisation.", "20 Lectures"),
                  _buildCurriculumTile("03", "Card Repertories & Computer Repertories", "Radar Opus, MacRepertory, Hompath, Complete Repertory comparison.", "15 Lectures"),
                ],
              ),
            ),
