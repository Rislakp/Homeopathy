...
class DeleteLiveClassDialog extends StatelessWidget {
  final String title;
  final VoidCallback onDelete;

  const DeleteLiveClassDialog({
    super.key,
    required this.title,
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'This action cannot be undone and the class record will be permanently removed.',
            style: GoogleFonts.inter(
              fontSize: 13,
