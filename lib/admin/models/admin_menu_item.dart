...
enum AdminMenuItem {
 ...
 // demoVideos(AdminMenuSection.overview, 'Demo Videos', Icons.smart_display_rounded),
 // liveClasses(AdminMenuSection.overview, 'Live Classes', Icons.live_tv_rounded),
 // recordedClasses(AdminMenuSection.overview, 'Recorded Classes', Icons.video_library_rounded),
 // assignments(AdminMenuSection.overview, 'Assignments', Icons.assignment_rounded),
 ...
 // questionBank(AdminMenuSection.overview, 'Question Bank', Icons.quiz_rounded),
  ...
  //fees(AdminMenuSection.overview, 'Fees', Icons.payments_rounded),
  //library(AdminMenuSection.overview, 'Library', Icons.local_library_rounded),
  // hostel(AdminMenuSection.overview, 'Hostel', Icons.apartment_rounded),
  ...
  logout(AdminMenuSection.overview, 'Logout', Icons.logout_rounded);
