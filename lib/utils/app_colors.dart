...
class AppColors {
  static const Color primary = Color(0xFF16A34A); // Primary Green
  ...
  // Status colors
  static const Color publishedBg = Color(0xFFDCFCE7);
  static const Color publishedText = Color(0xFF15803D);

  static const Color draftBg = Color(0xFFFEEFDE);
  static const Color draftText = Color(0xFFD97706);
